...
//  1. Added "Nepali" filter that loads from dedicated Nepali provider
//  2. "Trending" filter now uses reelsTrendingProvider (Deezer chart)
//  3. Trending badge (🔥) shown on chart-top tracks
//  4. Redesigned header with live song count
// ─────────────────────────────────────────────────────────────────────────────
...
//   final TextEditingController _searchCtrl = TextEditingController();
//   String _query = '';
//   String _activeFilter = 'Trending'; // ← default to trending
//   String? _playingId;
//   final AudioPlayer _player = AudioPlayer();
//   bool _playerLoading = false;
...
//   static const List<String> _filters = [
//     'Trending', // ← Deezer chart (real trending)
//     'All',
//     'Nepali', // ← dedicated Nepali tab
//     'Pop',
//     'Hip-Hop',
//     'Romantic',
//     'Party',
...
//   List<ReelsMusicTrack> _filtered(List<ReelsMusicTrack> all) {
//     var list = all;
//     if (_activeFilter == 'Trending' || _activeFilter == 'All') {
//       // no extra filter — provider already gives right data
//     } else if (_activeFilter == 'Nepali') {
//       // handled by separate provider — no local filter needed
//     } else {
//       final q = _activeFilter.toLowerCase();
//       list =
//           list
...
//     // ── Pick the right provider based on active filter ─────────────────────
//     AsyncValue<List<ReelsMusicTrack>> musicAsync;
//     if (_query.isNotEmpty) {
//       musicAsync = ref.watch(reelsMusicSearchProvider(_query));
//     } else if (_activeFilter == 'Trending') {
//       musicAsync = ref.watch(reelsTrendingProvider);
//     } else if (_activeFilter == 'Nepali') {
//       musicAsync = ref.watch(reelsNepaliProvider);
//     } else {
//       musicAsync = ref.watch(reelsMusicProvider);
//     }
...
//       body: Column(
//         children: [
//           SafeArea(bottom: false, child: _buildHeader(selected, musicAsync)),
//           _buildSearchBar(),
//           _buildFilterChips(),
//           const SizedBox(height: 4),
//           Expanded(
...
//                           onPressed: () {
//                             ref.invalidate(reelsMusicProvider);
//                             ref.invalidate(reelsTrendingProvider);
//                             ref.invalidate(reelsNepaliProvider);
//                             ref.invalidate(reelsMusicSearchProvider(_query));
//                           },
//                           child: Text(
//                             'Retry',
...
//                         tracks[i],
//                         selected,
//                         isTrending: i < 10 && _activeFilter == 'Trending',
//                       ),
//                 );
//               },
//             ),
...
//   Widget _buildHeader(
//     ReelsMusicTrack? selected,
//     AsyncValue<List<ReelsMusicTrack>> musicAsync,
//   ) {
//     final count = musicAsync.asData?.value.length ?? 0;
//     return Container(
//       padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
//       decoration: const BoxDecoration(
//         color: Color(0xFF0D0D0D),
