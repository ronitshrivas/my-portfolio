...
class GlassDrawer extends StatelessWidget {
  ...
  /// Menu tiles below the header. When null a sensible default set is shown.
  ...
  Widget build(BuildContext context) {
    ...
    final tiles = items ?? const <GlassDrawerItem>[];
...
class _ProfileHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final content = Padding(
      ...
      child: Row(
        children: [
          // Gradient ring around the avatar for a premium touch.
          Container(
