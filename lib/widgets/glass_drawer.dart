              ...
              child:
                  (avatarUrl != null && avatarUrl!.trim().isNotEmpty)
                      ? CachedFeedImage(
                        ...
                        memCacheWidth: 128,
                        memCacheHeight: 128,
                        errorWidget: _initialAvatar(name),
                      )
                      : _initialAvatar(name),
            ),
          ),
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: (_enabled ? BrandColors.accent : Colors.white).withValues(
                alpha: _enabled ? .22 : .14,
              ),
              border: Border.all(color: Colors.white.withValues(alpha: .22)),
            ),
            child: Icon(
              ...
              size: 18,
              color: _enabled ? BrandColors.accent : _ink.withValues(alpha: .7),
            ),
          ),
